...
class xwaterfallHistoryCard extends HTMLElement {
  constructor() {
    super();
      ...
      ${this.config.entities.map(entityConfig => {
        ...
        return `
          <div class="entity-container" data-entity-id="${entityId}" @click="${() => this.openMoreInfo(entityId)}">
            ...
            <div class="xwaterfall-container">
...
customElements.define('xwaterfall-history-card', xwaterfallHistoryCard);

window.customCards = window.customCards || [];
window.customCards.push({
  type: 'xwaterfall-history-card',
  name: 'xwaterfall History Card',
  description: 'A horizontal xwaterfall display for historical sensor data'
});
